...
public class Registro extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        name = view.findViewById(R.id.et_registroName);
        email = view.findViewById(R.id.et_registroEmail);
        password = view.findViewById(R.id.et_registroPassword);
        passwordConfirm = view.findViewById(R.id.et_registroConfirmPassword);

        registrar = view.findViewById(R.id.btn_registro);
